...
function number_from_bitfield(number, bitfield, type)                                                                                 
  -- retain only certain bits (equal to 1 in bitfield) in number to calculate the result                                              
  ...
  if poll == 1 then                                                                                         
    ...
    if bytes_read then                                                                                      
      ...
      if params[tonumber(clean_packet["HDR"]["NODEID"])] then -- makes sure a sending, but undefined jeenode_id doesn't crash this process
        ...
        -- print the packet contents, and values for debuggin purposes                                                               
        -- vardump(clean_packet)                                                                                                      
        vardump(sensor_values)                                                                                                        
